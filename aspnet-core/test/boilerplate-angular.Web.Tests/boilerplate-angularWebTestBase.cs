...
{
    public abstract class boilerplate-angularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static boilerplate-angularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(boilerplate-angularWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<boilerplate-angularDbContext> action)
        {
            using (var context = IocManager.Resolve<boilerplate-angularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<boilerplate-angularDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<boilerplate-angularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<boilerplate-angularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<boilerplate-angularDbContext, Task<T>> func)
        {
            T result;
