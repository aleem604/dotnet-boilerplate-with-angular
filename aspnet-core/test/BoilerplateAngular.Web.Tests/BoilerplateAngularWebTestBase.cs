...
{
    public abstract class BoilerplateAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerplateAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerplateAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerplateAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerplateAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerplateAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerplateAngularDbContext, Task<T>> func)
        {
            T result;
