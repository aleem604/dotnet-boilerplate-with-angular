...
public static class AngularBoilerplateEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AngularBoilerplateModuleExtensionConfigurator CLASS (in the Domain.Shared project)
