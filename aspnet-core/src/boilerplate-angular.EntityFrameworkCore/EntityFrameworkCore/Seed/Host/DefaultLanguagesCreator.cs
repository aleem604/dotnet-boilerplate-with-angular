...
namespace boilerplate-angular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly boilerplate-angularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = boilerplate-angularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(boilerplate-angularDbContext context)
        {
            _context = context;
        }
